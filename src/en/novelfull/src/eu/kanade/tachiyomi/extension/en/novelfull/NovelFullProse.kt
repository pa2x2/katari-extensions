...
internal data class NovelFullProseAsset(
    val id: String,
    val url: String,
...
internal fun Element.normalizeNovelFullProse(): List<NovelFullProseAsset> {
    normalizeProseLinks()
...
private fun Element.extractProseAssets(): List<NovelFullProseAsset> {
    val assets = linkedMapOf<String, NovelFullProseAsset>()
...
private fun String.rewriteProseFontFaces(
    baseUrl: String,
    assets: MutableMap<String, NovelFullProseAsset>,
