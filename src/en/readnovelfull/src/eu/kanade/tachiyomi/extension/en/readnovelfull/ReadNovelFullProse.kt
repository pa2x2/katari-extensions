...
internal data class ReadNovelFullProseAsset(
    val id: String,
    val url: String,
...
internal fun Element.normalizeReadNovelFullProse(): List<ReadNovelFullProseAsset> {
    normalizeProseLinks()
    return extractProseAssets()
}
...
private fun Element.extractProseAssets(): List<ReadNovelFullProseAsset> {
    val assets = linkedMapOf<String, ReadNovelFullProseAsset>()
    select("img[src]").forEach { image ->
        ...
        val asset = ReadNovelFullProseAsset(
...
private fun String.rewriteProseFontFaces(
    baseUrl: String,
    assets: MutableMap<String, ReadNovelFullProseAsset>,
